...
| $daynumber   | current day number (1-31)                                                 |
| $monthname   | current month name, culture/language can be set in Options                |
| $dayname     | current day name, culture/language can be set in Options                  |
...
| $vse         | Split value in slot 1 with Enter (NewLine), output value[number]          |
| $list        | Split lines in main textbox (skips line 1), output value[number]          |
| $lln2        | Split lines in mem2 for use in processing from other slot/text library    |
| $lln3        | Split lines in mem3 for use in processing from other slot/text library    |
...
| $X           | No processing, but separates a tag from the rest of the text              |
